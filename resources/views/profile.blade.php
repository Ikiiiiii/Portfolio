  ...
  <body>
    ...
    <div id="footer" class="container-fluid">
      <footer class="py-3 my-3 border-top">
        <p class="text-center text-black">&copy;2023 <a href="https://instagram.com/rzzafrr?igshid=YmMyMTA2M2Y=" target="_blank" class="fw-bold text-decoration-none">Rizky</a></p>
      </footer>
    </div>
    <!-- Akhir footer -->
  </body>
