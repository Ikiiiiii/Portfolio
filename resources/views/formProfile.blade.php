        ...
        <form style="margin-top: 6%" action="profile/update/{{$profile->id}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="mt-3 mb-2">
                    ...
                    <textarea class="form-control" name="alamat" id="alamat" cols="30" rows="5" value="{{ $profile->alamat }}"></textarea>
                </div>
                <div class="mt-3 mb-2">
                    <label for="" class="form-label">Jenis Kelamin</label>
                        <select name="jk" class="form-select" id="floatingSelect" aria-label="Floating label select example">
                          <option >Pilih Jenis Kelamin</option>
                          <option value="{{ $profile->jk }}">Laki-laki</option>
                          <option value="{{ $profile->jk }}">Perempuan</option>
                        </select>
                </div>
                <div class="mt-3 mb-2">
                ...
                <div class="mt-3 mb-2">
                    ...
                    <textarea class="form-control" name="about" id="about" cols="30" rows="5" value="{{ $profile->about }}"></textarea>
                </div>
